...
import BookingForm from "./BookingForm" // Assuming BookingForm is in a separate file
  ...
  return (
    <div>
      <div className="relative h-screen w-full">
        <HeroSection />
        {/* BookingForm is positioned absolutely relative to this h-screen div */}
        <div className="absolute bottom-0 left-0 right-0 transform translate-y-1/2 px-4 md:px-6 lg:px-8 z-10"> {/* Adjusted z-index to a lower value, still above content */}
          <BookingForm />
        </div>
      </div>
      
      <div className="pt-16 py-16 px-4 md:px-8 bg-white" id="rooms"> 
